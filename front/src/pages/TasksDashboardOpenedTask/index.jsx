...
const TasksDashboardOpenedTaskPage = () => {
  const sideBarMenu = [
    {
      icon: (
        <Img
    ...
    <>
      <div className="bg-white-A700 flex flex-col font-manrope items-center justify-start mx-auto sm:px-5 px-[35px] w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start mx-auto md:px-5 w-full">
          ...
          <div className="flex flex-1 flex-col gap-8 items-start justify-start ml-12 md:ml-[0] md:mt-0 mt-[105px] w-full">
            <div className="flex flex-col items-start justify-start w-full">
              ...
              <div className="flex flex-col font-dmsans items-center justify-start mt-[47px] w-[95%] md:w-full">
                <TasksDashboardCard
                  className="bg-white-A700 sm:h-[1657px] h-[345px] md:h-[457px] p-2.5 relative rounded-md shadow-bs w-[532px] sm:w-full"
                  uploadbutton="Upload your work"
                />
              </div>
              <Text
                className="mt-5 text-3xl sm:text-[26px] md:text-[28px] text-blue_gray-900_01"
                size="txtManropeBold30"
              >
                Collaborative Tasks
              </Text>
              <List
                className="sm:flex-col flex-row font-dmsans gap-10 grid sm:grid-cols-1 grid-cols-2 justify-center mt-[47px] w-full"
            ...
            <TasksDashboardCollabcard className="bg-white-A700 flex flex-col font-dmsans gap-4 items-start justify-start p-2.5 rounded-md shadow-bs w-[260px]" />
          </div>
          <Img
            className="h-[26px] max-h-[26px] md:ml-[0] ml-[184px] md:mt-0 mt-[49px] sm:w-[] md:w-[]"
            src="images/img_claritynotific.svg"
            alt="claritynotific"
          />
          <div className="bg-blue-400_63 flex flex-1 flex-col items-start justify-end mb-[932px] md:ml-[0] ml-[100px] md:mt-0 mt-8 p-[7px] rounded-[16px] w-full">
...
export default TasksDashboardOpenedTaskPage;
